...
$softwareCategories = @{
    "Development" = @{
        "IDEs & Editors" = @(
            ...
            @{Name = "Atom"; Type = "Winget"; Id = "GitHub.Atom"; Description = "Hackable text editor"},
            @{Name = "PyCharm Community"; Type = "Winget"; Id = "JetBrains.PyCharm.Community"; Description = "Python IDE"},
            @{Name = "Android Studio"; Type = "Winget"; Id = "Google.AndroidStudio"; Description = "Android development IDE"}
        )
        "Version Control" = @(
    ...
    "Multimedia" = @{
        "Media Players" = @(
            ...
            @{Name = "PotPlayer"; Type = "Winget"; Id = "Daum.PotPlayer"; Description = "Multimedia player"},
            @{Name = "K-Lite Codec Pack"; Type = "Winget"; Id = "CodecGuide.K-LiteCodecPack.Full"; Description = "Codec collection"}
        )
        "Audio Editing" = @(
    ...
    "Utilities" = @{
        "System Tools" = @(
            ...
            @{Name = "HWiNFO"; Type = "Winget"; Id = "REALiX.HWiNFO"; Description = "Hardware information tool"},
            @{Name = "CPU-Z"; Type = "Winget"; Id = "CPUID.CPU-Z"; Description = "CPU and system information"},
            @{Name = "GPU-Z"; Type = "Winget"; Id = "TechPowerUp.GPU-Z"; Description = "Graphics card information"},
            @{Name = "CrystalDiskInfo"; Type = "Winget"; Id = "CrystalDewWorld.CrystalDiskInfo"; Description = "Hard disk health monitoring"}
        )
        "File Management" = @(
